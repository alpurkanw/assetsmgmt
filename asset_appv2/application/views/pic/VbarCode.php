    ...
    <body class="hold-transition sidebar-mini">
                            ...
                            <div class="card card-outline card-info">
                                ...
                                <div class="card-body p-2">
                                    <div class="row">
                                        ...
                                        <div class="col-10">
                                            <input type="text" class="form-control kodebar" name="kodebar"
                                                placeholder="Silahkan Scan Barcode..." autofocus>
                                        </div>
                                        <div class="col-auto">
                                            <button class="btn btn-info btn_cari_by_barcode">Cari</button>
                                        </div>
                                    </div>
        ...
        $(document).ready(function() {
            $('.btn_cari_by_barcode').click(function() {
                kodebar = $('.kodebar').val();
                $.get('<?= base_url('pic/CcariBar/barCode_hasil/'); ?>' + kodebar, function(data) {
                    // alert('Data : ' + data);
