...
class UplGambar  extends CI_Controller
{
    ...
    public function barCode()
    {
        ...
        // $data["show"] = "databarang";
        // $this->load->view('pic/VcariFormParm', $data);
        $this->load->view('pic/VuplGambar', $data);
    }
                ...
                <div class="row">
                    <div class="col-lg-6  col-md-12 col-xs-12">
                        <div class="card card-outline card-info">
                            ...
                            <form action="' . base_url('pic/imageUpload_Controller/upload') . '" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                <input type="file" name="profile_pic" size="20">
                                <input type="hidden" name="kodebar" value="' . $brg[0]->kodebar . '">
                                <input type="hidden" name="from_page" value="uploadGambar">
                                <span class="badge bg-danger text-left">
                                    Note: <br>
                                    Hanya File dengan extension
                                    \'.gif .jpg .jpeg .png\' <br>
                                    dan ukuran Max 5 MB </span><br>
                                <input type="submit" class="btn btn-info mt-2" name="submit" value="UPLOAD">                                                     </form>
