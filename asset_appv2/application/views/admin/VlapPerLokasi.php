                        ...
                        <div class="col-12">
                            <div class="card card-info card-outline">
                                <div class="card-header">
                                    <h3 class="card-title">Laporan Barang Berdasarkan Lokasi </h3>
                                </div> <!-- /.card-body -->
                                <div class="card-body">
                                    <form action="<?= base_url("admin/ClapPerLokasi/submit"); ?>" class="form_submit"
                                        method="post">
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label text-right">Nama Lokasi </label>
                                            <div class="col-sm-8">
                                                <select name="lokasi" id="lokasi" class="form-control">
                                                    <option value="">.:Pilih Lokasi :.</option>
                                                    <?php foreach ($loks as $key => $lok) { ?>
                                                    <option value='<?= json_encode($lok); ?>'><?= $lok->namalok; ?>
                                                    </option>
                                                    <?php } ?>
                                                </select>
                                            ...
                                            <div class="col-sm-2">
                                                <button type="submit" class="btn btn-info btn-block btn_submit"
