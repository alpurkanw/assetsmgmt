...
class ChapusAset extends CI_Controller
{
    ...
    public function CariByName()
    {
        ...
        // echo "tes";
        $data["judul"] = "Form Pencarian Aset";
        $data["show"] = "index";

        // $data["kategs"] = $this->db->get('tbl_kateg')->result();
        $this->load->view('admin/VhapusAset', $data);
    ...
    public function barCode()
    {
        ...
        // $this->load->view('admin/VcariFormParm', $data);
        $this->load->view('admin/VbarCode', $data);
    }
                        ...
                        <div class="card card-outline card-info">
                            ...
                            <div class="row">
                                    ...
                                    <div class="col text-right">
                                        <a class="btn  btn-info" href="' . base_url("admin/Clistbar/detailBar/") . $brg[0]->kodebar . '">Detail</a>
                                    </div>
                                </div>
                            </div>
                            <!-- /.card-header -->
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="submit_update" action="' . base_url("admin/Clistbar/updBar/") . $kodebar . '"  method="POST">
                                    <div class="row">
                                        <div class="col">
                                            <label for="">
                                                Lokasi
    ...
    public function CariBynameSubmit()
    {
        ...
        $this->load->view('admin/Vlistbar', $data);
    }
