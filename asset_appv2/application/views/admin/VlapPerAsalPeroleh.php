                        ...
                        <div class="col-12">
                            <div class="card card-info card-outline">
                                <div class="card-header">
                                    <h3 class="card-title">Laporan Barang Berdasarkan Asal Perolehan</h3>
                                </div> <!-- /.card-body -->
                                <div class="card-body">
                                    <form action="<?= base_url("admin/ClapPerAsalPerolehan/submit"); ?>" class="form_submit" method="post">
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label text-right">Asal Perolehan </label>
                                            <div class="col-sm-8">
                                                <select name="asal" id="asal" class="form-control">
                                                    <option value="">.: Pilih Asal Perolehan :.</option>
                                                    <?php foreach ($asal as $key => $asl) { ?>
                                                        <option value='<?= json_encode($asl); ?>'><?= $asl->asal_peroleh; ?>
                                                        </option>
                                                    <?php } ?>
                                                </select>
                        ...
                        <div class="col-12">
                            <div class="card card-outline card-info">
                                <div class="card-header p-1">
                                    <h4>List Barang </h4>
                                    <h5> Asal perolehan
                                        : <?= json_decode($this->input->post('asal'), TRUE)["asal_peroleh"]; ?></h5>
                                </div>
                                <!-- /.card-header -->
        ...
        $(document).ready(function() {
            ...
            $('#list_lap_bar').DataTable({
                ...
                buttons: [{
                        "extend": 'pdf',
                        "title": 'List Barang ',
                        "messageTop": 'Berasal Dari : <?= json_decode($this->input->post('asal'), TRUE)["asal_peroleh"]; ?>',
