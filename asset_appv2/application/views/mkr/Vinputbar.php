                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="card ">
                                                <div class="card-body box-profile">
                                                    <form action="<?= base_url("mkr/Cinputbar/tambah"); ?>"
                                                        method="POST">

                                                        <div class=" form-group row">
                                                            <label class="col-sm-3 col-form-label text-right">Kategori
                                                                Barang</label>
                                                            <div class="col-sm-9">
                                                                <select name="kategori" id="kategori"
                                                                    ...
                                                                    <option value='<?= json_encode($ktg); ?>'>
                                                                        <?= $ktg->namakateg; ?></option>
                                                                    <?php } ?>
                                                                </select>
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-sm-3 col-form-label text-right">Merk
                                                                Barang</label>
                                                            <div class="col-sm-9">
                                                                <input type="text" name="merkbar" class="form-control"
                                                                    value="<?= set_value('merkbar'); ?>">
                                                                <?= form_error('merkbar', '<small class="text-danger pl-1">', '</small>'); ?>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-sm-3 col-form-label text-right">Nama
                                                                Barang</label>
                                                            <div class="col-sm-9">
                                                                <input type="text" name="namabar" class="form-control"
                                                                    value="<?= set_value('namabar'); ?>">
                                                                <?= form_error('namabar', '<small class="text-danger pl-1">', '</small>'); ?>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label
                                                                class="col-sm-3 col-form-label text-right">Jumlah</label>
                                                            <div class="col-sm-9">
                                                                <input type="text" name="jumbar" class="form-control"
                                                                    value="<?= set_value('jumbar'); ?>">
                                                                <?= form_error('jumbar', '<small class="text-danger pl-1">', '</small>'); ?>
                                                            </div>
                                                        </div>

                                                        <div class="form-group row">
                                                            <label class="col-sm-3 col-form-label text-right">Tahun
                                                                Anggaran</label>
                                                            <div class="col-sm-9">
                                                                <input type="text" name="thn_angg" class="form-control"
                                                                    value="<?= set_value('thn_angg'); ?>">
                                                                <?= form_error('thn_angg', '<small class="text-danger pl-1">', '</small>'); ?>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label
                                                                class="col-sm-3 col-form-label text-right">Harga</label>
                                                            <div class="col-sm-9">
                                                        ...
                                                        <div class="form-group row">
                                                            <label
                                                                class="col-sm-3 col-form-label text-right">Lokasi</label>
                                                            <div class="col-sm-9">
                                                                <input type="text" name="lokasi" class="form-control"
                                                                    value="<?= $_SESSION["lokid"] . "-" . $_SESSION["namalok"]; ?>"
                                                                    readonly>
                                                        ...
                                                        <div class="form-group row">
                                                            <label
                                                                class="col-sm-3 col-form-label text-right">Ruangan/Penempatan
                                                            </label>
                                                            <div class="col-sm-9">
                                                                <select name="ruangan" id="ruangan"
                                                                    ...
                                                                    <option value='<?= json_encode($ruang); ?>'>
                                                        ...
                                                        <div class=" form-group row">
                                                            <label class="col-sm-3 col-form-label text-right">Asal
                                                                Perolehan</label>
                                                            <div class="col-sm-9">
                                                                <select name="asal_peroleh" id="asal_peroleh"
                                                                    class="form-control">
                                                                    ...
                                                                    <option value="DANA JASA KAPITASI">DANA JASA
                                                                        KAPITASI</option>
                                                        ...
                                                        <div class=" form-group row">
                                                            <label
                                                                class="col-sm-3 col-form-label text-right">Kondisi</label>
                                                            <div class="col-sm-9">
                                                                <select name="kondisi" id="kondisi"
                                                                    ...
                                                                    <option value="PROSES PERBAIKAN">PROSES PERBAIKAN
                                                                    </option>
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-sm-3 col-form-label text-right">Keterangan
                                                            </label>
                                                            <div class="col-sm-9">
                                                                <textarea class="form-control"
                                                                    placeholder="Berisi Keterangan tambahan .."
                                                                    name="ket" id="ket" rows="5"></textarea>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class=" modal-footer ">
                                                            <div class=" row">
                                                                <div class="col-12 ">
                                                                    ...
                                                                    <button type="submit"
                                                                        class="btn btn-info form_submit"
