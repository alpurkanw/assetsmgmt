                        ...
                        <div class="col-lg-10 col-md-10 col-sm-12 ">
                            <div class="card card-outline card-info">
                                ...
                                <div class="card-body p-2">
                                    <form action="<?= base_url("pic/CcariBar/CariBynameSubmit"); ?>" method="post"
                                        class="form_submit_cariByname">
                                        <div class="row">
                                            <div class="col-10">
                                                <input type="text" class="form-control" name="keyWordCari"
                                                    placeholder="Masukan Nama Barang" autofocus>
                                            </div>
                                            <div class="col-auto">
                    ...
                    <div class="row">
                        <div class="col-lg-10 col-md-10 col-sm-12 ">
                            <div class="card card-outline card-info">
                                ...
                                <!-- /.card-header -->
                                <div class="card-body p-2">
                                    <form action="<?= base_url("pic/CcariBar/CariBykategSubmit"); ?>" method="post"
                                        class="form_submit_cariByname">
                                        <div class="row">
