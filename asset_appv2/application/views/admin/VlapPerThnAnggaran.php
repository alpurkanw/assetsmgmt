                        ...
                        <div class="col-12">
                            <div class="card card-info card-outline">
                                <div class="card-header">
                                    <h3 class="card-title">Laporan Barang Berdasarkan Tahun Anggaran</h3>
                                </div> <!-- /.card-body -->
                                <div class="card-body">
                                    <form action="<?= base_url("admin/ClapPerThnAnggaran/submit"); ?>" class="form_submit" method="post">
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label text-right">Tahun Anggaran </label>
                                            <div class="col-sm-8">
                                                <select name="thn" id="thn" class="form-control">
                                                    <option value="">.: Pilih Tahun Anggaran :.</option>
                                                    <?php foreach ($thns as $key => $thn) { ?>
                                                        <option value='<?= json_encode($thn); ?>'><?= $thn->thn_angg; ?>
                                                        </option>
                                                    <?php } ?>
                                                </select>
                        ...
                        <div class="col-12">
                            <div class="card card-outline card-info">
                                <div class="card-header p-1">
                                    <h4>List Barang </h4>
                                    <h5>Tahun Anggaran <?= json_decode($this->input->post('thn'), TRUE)["thn_angg"]; ?>
                                    </h5>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body p-2">
                                    ...
                                    <div class="tes_data">
                                        <table id="list_lap_bar" class="table table-sm text-sm table-bordered table-striped  " role="grid" aria-describedby="example1_info">
                                            <thead>
                                                <tr role="row">
                                                    <th>No</th>
                                                    <th>Kode Barang</th>
        ...
        $(document).ready(function() {
            ...
            $('#list_lap_bar').DataTable({
                ...
                buttons: [{
                        "extend": 'pdf',
                        "title": 'List Barang ',
                        "messageTop": 'Tahun Anggaran : <?= json_decode($this->input->post('thn'), TRUE)["thn_angg"]; ?>',
